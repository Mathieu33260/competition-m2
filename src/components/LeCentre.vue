<template>
    <div>
        <b-row>
            <b-col cols="12">
                <img src="../assets/lecentre.png" style="width: 100%"/>
            </b-col>
        </b-row>

        <b-row class="d-flex justify-content-end">
            <b-col cols="11" style="border-left: 10px solid #65FFF9; height: 200px">
        ...
        <b-row class="d-flex justify-content-end mt-5">
            <b-col cols="5" class="pl-0">
                <div class="d-flex flex-column justify-content-around">
                    <div style="font: Bold 20px/22px Gotham;" class="mb-2">
                        Un peu d'histoire
                    </div>
                    ...
                    <div style="font-size: 80%">
                        ...
                        <br><br>La base sous-marine s’enracine ainsi à l’emplacement du réservoir d’alimentation du bassin à flot n° 2, destiné à devenir le bassin à flot n° 3, à l’aide de trois mille poutres en béton armé assurant sa stabilité dans le sol tourbeux
                    </div>
                </div>
            </b-col>
            ...
            <b-col cols="6" class="d-flex justify-content-center">
                <div style="width: 80%">
                    <img src="../assets/histoire.png" style="width: 100%"/>
                </div>
            </b-col>
        </b-row>

        <b-row class="d-flex justify-content-center">
            <b-col cols="8" style="border-right: 10px solid #65FFF9; height: 200px">

            </b-col>
        </b-row>

        <b-row>
            <b-col cols="6" class="d-flex justify-content-center ml-5">
                <div style="width: 100%">
                    <img src="../assets/planbase.png" style="width: 100%"/>
                </div>
            </b-col>

            <b-col cols="5" class="d-flex flex-column justify-content-around p-4 mr-5">
                <div style="font: Bold 20px/22px Gotham;" class="mt-2">
                    Le Centre
                </div>
                ...
                <div style="width: 10%">
                    <img src="../assets/téléchargement.png" style="width: 100%"/>
                </div>
            </b-col>
        </b-row>
        ...
        <b-row>
            ...
            <b-col cols="6" style="border-left: 10px solid #65FFF9; height: 100px">
